...
func (c *engineClient) Input(ctx context.Context, opts ...grpc.CallOption) (Engine_InputClient, error) {
	stream, err := c.cc.NewStream(ctx, &Engine_ServiceDesc.Streams[0], Engine_Input_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *engineClient) Notify(ctx context.Context, opts ...grpc.CallOption) (Engine_NotifyClient, error) {
	stream, err := c.cc.NewStream(ctx, &Engine_ServiceDesc.Streams[1], Engine_Notify_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *parsingClient) ParseLog(ctx context.Context, in *JLog, opts ...grpc.CallOption) (*JLog, error) {
	out := new(JLog)
	err := c.cc.Invoke(ctx, Parsing_ParseLog_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *analysisClient) Analyze(ctx context.Context, in *Event, opts ...grpc.CallOption) (*Alert, error) {
	out := new(Alert)
	err := c.cc.Invoke(ctx, Analysis_Analyze_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
