...
func (*Expression) Descriptor() ([]byte, []int) {
	return file_plugins_proto_rawDescGZIP(), []int{36}
}
...
const file_plugins_proto_rawDesc = "" +
	...
	"\x06ofType\x18\x03 \x01(\tR\x06ofType\"\xd5\x03\n" +
	"\x04Rule\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x04R\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12\x1a\n" +
	"\bcategory\x18\x04 \x01(\tR\bcategory\x12\x1c\n" +
	"\ttechnique\x18\x05 \x01(\tR\ttechnique\x12\x1e\n" +
	"\n" +
	"references\x18\x06 \x03(\tR\n" +
	"references\x12\x1c\n" +
	"\tdataTypes\x18\a \x03(\tR\tdataTypes\x12\x1c\n" +
	"\tadversary\x18\b \x01(\tR\tadversary\x12'\n" +
	"\x06impact\x18\t \x01(\v2\x0f.plugins.ImpactR\x06impact\x12\x14\n" +
	"\x05where\x18\n" +
	" \x01(\tR\x05where\x128\n" +
	"\vafterEvents\x18\v \x03(\v2\x16.plugins.SearchRequestR\vafterEvents\x12$\n" +
	"\rdeduplicateBy\x18\f \x03(\tR\rdeduplicateBy\x12\x18\n" +
	"\agroupBy\x18\r \x03(\tR\agroupBy\x128\n" +
	"\vcorrelation\x18\x0e \x03(\v2\x16.plugins.SearchRequestR\vcorrelation\"\xb2\x01\n" +
	"\rSearchRequest\x12\"\n" +
...
var file_plugins_proto_msgTypes = make([]protoimpl.MessageInfo, 43)
